...
const Notifications = () => {
  ...
  const notifications = workersState.notifications.length ? workersState.notifications : [];
  ...
  return (
    <div className="dropdown cart-dropdown" style={{marginRight: 15}}> 
      <svg
        ...
        fill={hovered ? sellerConfigs.Theme.ColorPalette["Primary"] : sellerConfigs.Theme.ColorPalette["Gray-10"]}
      >
